...
},{"/media/truecrypt1/www/javascript/clappr-channels/node_modules/lodash.template/node_modules/lodash.reinterpolate/node_modules/lodash._reinterpolate/index.js":14}],17:[function(require,module,exports){
/**
 * lodash 3.0.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
module.exports={
  ...
  "version": "0.0.1",
  "repository": "irongomme/clappr-channels",
  "author": {
    "name": "Jérôme DENIS",
    "email": "irongomme@gmail.com",
    "url": "https://github.com/irongomme"
  },
  "keywords": [
    "clappr",
    "plugin"
...
var Channels = (function (_UiCorePlugin) {
	function Channels(core) {
		...
		_get(Object.getPrototypeOf(Channels.prototype), "constructor", this).call(this, core);
	}

	_inherits(Channels, _UiCorePlugin);
	...
	_createClass(Channels, {
		...
		assignCurrentChannel: {
			value: function assignCurrentChannel(source) {
		...
		getPoster: {
			value: function getPoster(source) {
		...
		render: {
			value: function render() {
				...
				if (this.channelsPosterRefresh) {
					this.posterRefreshId = setInterval(function () {
						return _this.refreshPosters();
					}, this.channelsPosterRefresh);
				}
		...
		refreshPosters: {
			value: function refreshPosters() {
				var channels = this.core.$el.find("[data-channel-link]"),
				    self = this;
...
},{".././jst":2,"lodash.template":3,"zepto":"zepto"}]},{},[1]);
